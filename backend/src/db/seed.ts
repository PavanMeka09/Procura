...
const knowledge = [
  ...
  { type: 'HISTORICAL_QUOTE', title: 'Historical laptop quotes', content: 'Comparable laptop quotes range from ₹55,000 to ₹62,000 per unit. Price is evaluated together with delivery, warranty, and payment terms.', metadata: { category: 'Business hardware' } },
